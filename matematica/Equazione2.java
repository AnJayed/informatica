...
import javafx.scene.input.KeyEvent;
	...
	public class Equazione2 extends Application {
		...
		public void start(Stage finestra) {
		    ...
		    finestra.addEventHandler(KeyEvent.KEY_PRESSED, event -> {
		        if (event.getCode() == KeyCode.ENTER) {
		            bCalcolasoluzioni.fire();
		        }
		    });
		...
		public void calcoli() {
		    ...
		    if (discriminante > 0) {
		        ...
		        eSoluzioni.setText("Soluzioni: x1 = " + soluzione1 + ", x2 = " + 2);
		    } else if (discriminante == 0) {

		        double root = -b / (2 * a);
		        eSoluzioni.setText("Soluzione doppia: x = " + root);
		    } else {
